<template>
  <view>
    <view class="pt15">
      <view class="pl15 pr15">请填写燃气工程入驻申请资料</view>
      <view class="ml15 mr15 mt10 pl10 pr10 bgcolors fs12"
        >商家开通燃气工程服务，平台将按年收取￥100的费用</view
      >
      <u-form :model="form" label-position="top" ref="uForm">
        <view class="mt15 ml15 mr15  pl15 pr15 bg-white br10">
          ...
          <u-form-item label-width="130" label="店铺地址" prop="name">
            <u-input
